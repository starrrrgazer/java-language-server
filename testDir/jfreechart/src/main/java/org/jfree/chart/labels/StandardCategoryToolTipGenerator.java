 ...
 */
public class StandardCategoryToolTipGenerator<R extends Comparable<R>, C extends Comparable<C>> extends AbstractCategoryItemLabelGenerator<R, C> implements CategoryToolTipGenerator<R, C>, Serializable {
     ...
     */
    @Override
    public String generateToolTip(CategoryDataset<R, C> dataset, int row, int column) {
