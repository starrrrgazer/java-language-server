 ...
 */
public abstract class AbstractCategoryItemLabelGenerator<R extends Comparable<R>, C extends Comparable<C>> implements PublicCloneable, Cloneable, Serializable {
     ...
     */
    protected String generateLabelString(CategoryDataset<R, C> dataset, int row, int column) {
     ...
     */
    protected Object[] createItemArray(CategoryDataset<R, C> dataset, int row, int column) {
    ...
    public boolean equals(Object obj) {
        ...
        AbstractCategoryItemLabelGenerator<R, C> that = (AbstractCategoryItemLabelGenerator<R, C>) obj;
    ...
    public Object clone() throws CloneNotSupportedException {
        AbstractCategoryItemLabelGenerator<R, C> clone = (AbstractCategoryItemLabelGenerator<R, C>) super.clone();
        if (this.numberFormat != null) {
