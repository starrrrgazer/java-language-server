 ...
 */
public class StandardPieToolTipGenerator<K extends Comparable<K>> extends AbstractPieItemLabelGenerator<K> implements PieToolTipGenerator<K>, Cloneable, PublicCloneable, Serializable {
