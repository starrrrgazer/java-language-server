 ...
 */
public class StandardCategoryItemLabelGenerator<R extends Comparable<R>, C extends Comparable<C>> extends AbstractCategoryItemLabelGenerator<R, C> implements CategoryItemLabelGenerator<R, C>, Cloneable, PublicCloneable, Serializable {
