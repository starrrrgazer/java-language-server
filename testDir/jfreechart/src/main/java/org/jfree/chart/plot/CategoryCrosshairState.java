...
public class CategoryCrosshairState<R extends Comparable<R>, C extends Comparable<C>> extends CrosshairState {
     ...
     */
    public void updateCrosshairPoint(R rowKey, C columnKey, double value, int datasetIndex, double transX, double transY, PlotOrientation orientation) {
     ...
     * @param orientation  the plot orientation.
     */
    public void updateCrosshairX(R rowKey, C columnKey, int datasetIndex, double transX, PlotOrientation orientation) {
        Point2D anchor = getAnchor();
        if (anchor != null) {
