 ...
 */
public class StandardPieSectionLabelGenerator<K extends Comparable<K>> extends AbstractPieItemLabelGenerator<K> implements PieSectionLabelGenerator<K>, Cloneable, PublicCloneable, Serializable {
     ...
     */
    @Override
    public AttributedString generateAttributedSectionLabel(PieDataset<K> dataset, K key) {
