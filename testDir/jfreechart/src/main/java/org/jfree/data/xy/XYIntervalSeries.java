 ...
 */
public class XYIntervalSeries<S extends Comparable<S>> extends ComparableObjectSeries<S> {
     ...
     */
    public XYIntervalSeries(S key, boolean autoSort, boolean allowDuplicateXValues) {
