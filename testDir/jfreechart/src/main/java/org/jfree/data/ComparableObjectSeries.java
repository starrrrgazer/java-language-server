 ...
 */
public class ComparableObjectSeries<K extends Comparable<K>> extends Series<K> implements Cloneable, Serializable {
     ...
     */
    public ComparableObjectSeries(K key, boolean autoSort, boolean allowDuplicateXValues) {
        super(key);
