...
public abstract class Statistics {
     ...
     * @since 1.0.3
     */
    public static double calculateMean(Collection<? extends Number> values, boolean includeNullAndNaN) {
        Args.nullNotPermitted(values, "values");
        int count = 0;
        double total = 0.0;
     ...
     * @return The median.
     */
    public static double calculateMedian(List<? extends Number> values, int start, int end, boolean copyAndSort) {
        double result = Double.NaN;
        if (copyAndSort) {
