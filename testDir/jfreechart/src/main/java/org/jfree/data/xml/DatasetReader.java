...
public class DatasetReader {
     ...
     */
    public static PieDataset<String> readPieDatasetFromXML(File file) throws IOException {
     ...
     */
    public static PieDataset<String> readPieDatasetFromXML(InputStream in) throws IOException {
        try {
     ...
     * @throws IOException if there is a problem reading the file.
     */
    public static CategoryDataset<String, String> readCategoryDatasetFromXML(InputStream in) throws IOException {
        try {
            SAXParser parser = getSAXParserFactory().newSAXParser();
