...
public class DefaultStatisticalCategoryDatasetTest {
    ...
    public void testGetRangeBounds() {
        DefaultStatisticalCategoryDataset<String, String> d = new DefaultStatisticalCategoryDataset<>();
    ...
    public void testRemove() {
        DefaultStatisticalCategoryDataset<String, String> data = new DefaultStatisticalCategoryDataset<>();
        boolean pass = false;
        try {
            data.remove("R1", "R2");
