...
public class TimeSeriesCollectionTest {
    ...
    public void testFindDomainBounds() {
        ...
        Range r = DatasetUtils.findDomainBounds(dataset, visibleSeriesKeys, true);
        assertNull(r);
        TimeSeries<String> s1 = new TimeSeries<>("S1");
        dataset.addSeries(s1);
    ...
    public void testBug3445507() {
        ...
        keys.add("S1");
        keys.add("S2");
        Range r = dataset.getRangeBounds(keys, new Range(Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY), false);
    ...
    public void testGetRangeBounds2() {
        ...
        assertEquals(new Range(10.0, 10.0), collection.getRangeBounds(Collections.singletonList("S1"), range, true));
        collection.setXPosition(TimePeriodAnchor.MIDDLE);
        assertEquals(new Range(10.0, 10.0), collection.getRangeBounds(Collections.singletonList("S1"), range, true));
