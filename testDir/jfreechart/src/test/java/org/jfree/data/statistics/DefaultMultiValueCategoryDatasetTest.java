...
public class DefaultMultiValueCategoryDatasetTest {
    ...
    public void testGetValue() {
        DefaultMultiValueCategoryDataset<String, String> d = new DefaultMultiValueCategoryDataset<>();
    ...
    public void testEquals() {
        DefaultMultiValueCategoryDataset<String, String> d1 = new DefaultMultiValueCategoryDataset<>();
        DefaultMultiValueCategoryDataset<String, String> d2 = new DefaultMultiValueCategoryDataset<>();
        assertEquals(d1, d2);
        assertEquals(d2, d1);
        List<Number> values = new ArrayList<>();
        d1.add(values, "R1", "C1");
    ...
    public void testSerialization() {
        DefaultMultiValueCategoryDataset<String, String> d1 = new DefaultMultiValueCategoryDataset<>();
        DefaultMultiValueCategoryDataset<String, String> d2 = TestUtils.serialised(d1);
        assertEquals(d1, d2);
    }
