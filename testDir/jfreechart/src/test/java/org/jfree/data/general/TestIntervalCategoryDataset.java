 ...
 */
public class TestIntervalCategoryDataset<R extends Comparable<R>, C extends Comparable<C>> extends AbstractDataset implements IntervalCategoryDataset<R, C>, PublicCloneable, Serializable {
     ...
     */
    public void addItem(Number value, Number lower, Number upper, R rowKey, C columnKey) {
     ...
     * @see #getValue(Comparable, Comparable)
     */
    public void addItem(double value, double lower, double upper, R rowKey, C columnKey) {
        addItem(Double.valueOf(value), Double.valueOf(lower), Double.valueOf(upper), rowKey, columnKey);
    }
     ...
     * @see #getValue(Comparable, Comparable)
     */
    public void setItem(Number value, Number lower, Number upper, R rowKey, C columnKey) {
        IntervalDataItem item = new IntervalDataItem(value, lower, upper);
        this.data.addObject(item, rowKey, columnKey);
        fireDatasetChanged();
    }
     ...
     * @see #getValue(Comparable, Comparable)
     */
    public void setItem(double value, double lower, double upper, R rowKey, C columnKey) {
        setItem(Double.valueOf(value), Double.valueOf(lower), Double.valueOf(upper), rowKey, columnKey);
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        TestIntervalCategoryDataset<R, C> clone = (TestIntervalCategoryDataset) super.clone();
