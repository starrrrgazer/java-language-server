...
public class SlidingCategoryDatasetTest {
    ...
    public void testCloning() throws CloneNotSupportedException {
        ...
        u1.addValue(3.0, "R1", "C3");
        assertNotEquals(d1, d2);
        DefaultCategoryDataset<String, String> u2 = (DefaultCategoryDataset<String, String>) d2.getUnderlyingDataset();
        u2.addValue(3.0, "R1", "C3");
        assertEquals(d1, d2);
    }
    ...
    public void testGetColumnCount() {
        ...
        SlidingCategoryDataset<String, String> dataset = new SlidingCategoryDataset<>(underlying, 10, 2);
    ...
    public void testGetRowCount() {
        DefaultCategoryDataset<String, String> underlying = new DefaultCategoryDataset<>();
        SlidingCategoryDataset<String, String> dataset = new SlidingCategoryDataset<>(underlying, 10, 5);
    ...
    public void testGetColumnIndex() {
        ...
        SlidingCategoryDataset<String, String> dataset = new SlidingCategoryDataset<>(underlying, 1, 2);
