...
public class DatasetUtilsTest {
    ...
    public void testCalculatePieDatasetTotal() {
        ...
        assertEquals(0.0, DatasetUtils.calculatePieDatasetTotal(d), EPSILON);
        d.setValue("A", 1.0);
        assertEquals(1.0, DatasetUtils.calculatePieDatasetTotal(d), EPSILON);
        d.setValue("B", 3.0);
        assertEquals(4.0, DatasetUtils.calculatePieDatasetTotal(d), EPSILON);
    }
    ...
    public void testCreateCategoryDataset1() {
        ...
        CategoryDataset<String, String> dataset = DatasetUtils.createCategoryDataset(rowKeys, columnKeys, data);
    ...
    public void testCreateCategoryDataset2() {
        ...
        try {
            dataset = DatasetUtils.createCategoryDataset(rowKeys, columnKeys, data);
    ...
    public void testLimitPieDataset() {
        ...
        PieDataset<String> d2 = DatasetUtils.<String>createConsolidatedPieDataset(d1, "Other", 0.05);
    ...
    public void testSampleFunction2D() {
        ...
        XYDataset<String> dataset = DatasetUtils.sampleFunction2D(f, 0.0, 1.0, 2, "S1");
    ...
    public void testIterateToFindDomainBounds_IntervalXYDataset() {
        ...
        double[][] data1 = new double[][] { x1, x1Start, x1End, y1, y1Start, y1End };
        dataset.addSeries("S1", data1);
        Range r = DatasetUtils.iterateToFindDomainBounds(dataset, Arrays.asList("S1"), true);
        assertEquals(0.8, r.getLowerBound(), EPSILON);
        assertEquals(3.2, r.getUpperBound(), EPSILON);
    }
    ...
    public void testIterateToFindRangeBounds_IntervalXYDataset() {
        ...
        double[][] data1 = new double[][] { x1, x1Start, x1End, y1, y1Start, y1End };
        dataset.addSeries("S1", data1);
        Range r = DatasetUtils.iterateToFindRangeBounds(dataset, Arrays.asList("S1"), new Range(0.0, 4.0), true);
    ...
    public void testIterateToFindRangeBounds1_XYDataset() {
        ...
        boolean pass = false;
        try {
            DatasetUtils.iterateToFindRangeBounds(null, new ArrayList<String>(), new Range(0.0, 1.0), true);
        } catch (IllegalArgumentException e) {
            pass = true;
        }
        assertTrue(pass);
        ...
        pass = false;
        try {
            DatasetUtils.iterateToFindRangeBounds(new XYSeriesCollection<String>(), null, new Range(0.0, 1.0), true);
        } catch (IllegalArgumentException e) {
            pass = true;
        }
        assertTrue(pass);
        ...
        pass = false;
        try {
            DatasetUtils.iterateToFindRangeBounds(new XYSeriesCollection<String>(), new ArrayList<>(), null, true);
        } catch (IllegalArgumentException e) {
            pass = true;
        }
        assertTrue(pass);
    ...
    public void testIterateToFindRangeBounds2_XYDataset() {
        ...
        XYSeriesCollection<String> dataset = new XYSeriesCollection<>();
        Range r = DatasetUtils.iterateToFindRangeBounds(dataset, visibleSeriesKeys, xRange, false);
        assertNull(r);
        // add an empty series
        XYSeries<String> s1 = new XYSeries<>("A");
        dataset.addSeries(s1);
        visibleSeriesKeys.add("A");
        r = DatasetUtils.iterateToFindRangeBounds(dataset, visibleSeriesKeys, xRange, false);
        assertNull(r);
        // check a null value
        s1.add(1.0, null);
        r = DatasetUtils.iterateToFindRangeBounds(dataset, visibleSeriesKeys, xRange, false);
        ...
        r = DatasetUtils.iterateToFindRangeBounds(dataset, visibleSeriesKeys, xRange, false);
        assertEquals(new Range(5.0, 15.0), r);
        r = DatasetUtils.iterateToFindRangeBounds(dataset, visibleSeriesKeys, new Range(0.0, 20.0), false);
    ...
    public void testIterateToFindRangeBounds_MultiValueCategoryDataset() {
        ...
        List<String> visibleSeriesKeys = new ArrayList<>();
        assertNull(DatasetUtils.<String, String>iterateToFindRangeBounds(dataset, visibleSeriesKeys, true));
        List<Double> values = Arrays.asList(new Double[] { 1.0 });
        dataset.add(values, "R1", "C1");
        visibleSeriesKeys.add("R1");
        assertEquals(new Range(1.0, 1.0), DatasetUtils.<String, String>iterateToFindRangeBounds(dataset, visibleSeriesKeys, true));
        values = Arrays.asList(new Double[] { 2.0, 3.0 });
        dataset.add(values, "R1", "C2");
        assertEquals(new Range(1.0, 3.0), DatasetUtils.<String, String>iterateToFindRangeBounds(dataset, visibleSeriesKeys, true));
        values = Arrays.asList(new Double[] { -1.0, -2.0 });
        dataset.add(values, "R2", "C1");
        assertEquals(new Range(1.0, 3.0), DatasetUtils.<String, String>iterateToFindRangeBounds(dataset, visibleSeriesKeys, true));
        visibleSeriesKeys.add("R2");
        assertEquals(new Range(-2.0, 3.0), DatasetUtils.<String, String>iterateToFindRangeBounds(dataset, visibleSeriesKeys, true));
    }
    ...
    public void testIterateRangeBounds_IntervalCategoryDataset() {
        TestIntervalCategoryDataset<String, String> d = new TestIntervalCategoryDataset<>();
