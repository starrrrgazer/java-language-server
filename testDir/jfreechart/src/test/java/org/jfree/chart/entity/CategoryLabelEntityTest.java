...
public class CategoryLabelEntityTest {
    ...
    public void testEquals() {
        CategoryLabelEntity<String> e1 = new CategoryLabelEntity<>("A", new Rectangle2D.Double(1.0, 2.0, 3.0, 4.0), "ToolTip", "URL");
        CategoryLabelEntity<String> e2 = new CategoryLabelEntity<>("A", new Rectangle2D.Double(1.0, 2.0, 3.0, 4.0), "ToolTip", "URL");
        assertEquals(e1, e2);
