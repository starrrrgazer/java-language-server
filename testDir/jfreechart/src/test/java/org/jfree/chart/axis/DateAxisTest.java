...
public class DateAxisTest {
    ...
    public void testBug2201869() {
        ...
        axis.setTickMarkPosition(DateTickMarkPosition.END);
        List<? extends Tick> ticks = axis.refreshTicks(g2, new AxisState(), area, RectangleEdge.BOTTOM);
    ...
    public void testBug25() {
        ...
        // 1420070400000L
        long ymillis = y.getFirstMillisecond(cal);
        ...
        // 1472040600000L GMT
        long minmillis = min.getFirstMillisecond(cal);
