...
public class PiePlotTest {
    ...
    public void testEquals() {
        ...
        assertEquals(plot1, plot2);
        // defaultSectionPaint
        plot1.setDefaultSectionPaint(new GradientPaint(1.0f, 2.0f, Color.BLACK, 3.0f, 4.0f, Color.WHITE));
        assertNotEquals(plot1, plot2);
        plot2.setDefaultSectionPaint(new GradientPaint(1.0f, 2.0f, Color.BLACK, 3.0f, 4.0f, Color.WHITE));
        assertEquals(plot1, plot2);
        ...
        plot1.setDefaultSectionOutlinePaint(new GradientPaint(1.0f, 2.0f, Color.GRAY, 3.0f, 4.0f, Color.WHITE));
        assertNotEquals(plot1, plot2);
        plot2.setDefaultSectionOutlinePaint(new GradientPaint(1.0f, 2.0f, Color.GRAY, 3.0f, 4.0f, Color.WHITE));
        assertEquals(plot1, plot2);
        ...
        assertEquals(plot1, plot2);
        // labelPaint
        plot1.setLabelPaint(new GradientPaint(1.0f, 2.0f, Color.DARK_GRAY, 3.0f, 4.0f, Color.WHITE));
        assertNotEquals(plot1, plot2);
        plot2.setLabelPaint(new GradientPaint(1.0f, 2.0f, Color.DARK_GRAY, 3.0f, 4.0f, Color.WHITE));
        assertEquals(plot1, plot2);
    ...
    static class NullLegendLabelGenerator implements PieSectionLabelGenerator<String> {
        ...
        @Override
        public AttributedString generateAttributedSectionLabel(PieDataset<String> dataset, String key) {
            return null;
        }
