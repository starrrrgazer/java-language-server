...
public class CategoryPlotTest {
    ...
    public void testAxisRange() {
        ...
        CategoryPlot<String, String> plot = new CategoryPlot<>(datasetA, new CategoryAxis(null), new NumberAxis(null), new LineAndShapeRenderer());
    ...
    public void testSerialization() {
        ...
        CategoryPlot<String, String> p1 = new CategoryPlot<>(dataset, domainAxis, rangeAxis, renderer);
    ...
    public void testSerialization2() {
        ...
        NumberAxis rangeAxis = new NumberAxis("Range");
        BarRenderer renderer = new BarRenderer();
        CategoryPlot<String, String> p1 = new CategoryPlot<>(data, domainAxis, rangeAxis, renderer);
    ...
    public void testSerialization5() {
        ...
        CategoryPlot<String, String> p1 = new CategoryPlot<>(dataset1, domainAxis1, rangeAxis1, renderer1);
        ...
        @SuppressWarnings("unchecked")
        DefaultCategoryDataset<String, String> datasetA = (DefaultCategoryDataset) p2.getDataset(0);
        ...
        @SuppressWarnings("unchecked")
        DefaultCategoryDataset<String, String> datasetB = (DefaultCategoryDataset) p2.getDataset(1);
    ...
    public void testAddDomainMarker() {
        ...
        List<EventListener> listeners = Arrays.asList(m.getListeners(MarkerChangeListener.class));
    ...
    public void testGetDomainAxisIndex() {
        ...
        CategoryPlot<String, String> plot = new CategoryPlot<>(null, domainAxis1, rangeAxis1, null);
    ...
    public void testGetDomainAxisForDataset() {
        ...
        CategoryPlot<String, String> plot = new CategoryPlot<>(dataset, xAxis, yAxis, renderer);
