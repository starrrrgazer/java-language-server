...
public class StackedXYAreaRendererTest {
    ...
    public void testFindRangeBounds() {
        TableXYDataset<String> dataset = RendererXYPackageUtils.createTestTableXYDataset();
    ...
    public void testDrawWithNullInfo() {
        try {
            ...
            XYPlot<String> plot = new XYPlot<>(dataset, new NumberAxis("X"), new NumberAxis("Y"), new StackedXYAreaRenderer());
    ...
    public void testBug1593156() {
        try {
            ...
            XYPlot<String> plot = new XYPlot<>(dataset, new NumberAxis("X"), new NumberAxis("Y"), renderer);
            JFreeChart chart = new JFreeChart(plot);
            /* BufferedImage image = */
            chart.createBufferedImage(300, 200, null);
        } catch (NullPointerException e) {
