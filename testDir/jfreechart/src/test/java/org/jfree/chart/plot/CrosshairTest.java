...
public class CrosshairTest {
    ...
    public void equalsContract() {
        EqualsVerifier.forClass(Crosshair.class).suppress(Warning.NULL_FIELDS, Warning.STRICT_INHERITANCE, Warning.NONFINAL_FIELDS, Warning.TRANSIENT_FIELDS).verify();
    }
