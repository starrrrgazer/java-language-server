...
public class XYStepChartTest {
    ...
    public void testReplaceDataset() {
        ...
        assertTrue(range.getLowerBound() <= 10, "Expecting the lower bound of the range to be around 10: " + range.getLowerBound());
        assertTrue(range.getUpperBound() >= 30, "Expecting the upper bound of the range to be around 30: " + range.getUpperBound());
    }
    ...
    private static JFreeChart createChart() {
        ...
        // create the chart...
        return // chart title
        ChartFactory.// chart title
        createXYStepChart(// data
        "Step Chart", // data
        "Domain", // data
        "Range", // include legend
        dataset, // include legend
        PlotOrientation.VERTICAL, // tooltips
        true, // urls
        true, true);
    }
