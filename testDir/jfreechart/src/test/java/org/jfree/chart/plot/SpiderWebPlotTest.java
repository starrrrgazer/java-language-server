...
public class SpiderWebPlotTest {
    ...
    public void testEquals() {
        ...
        assertEquals(p1, p2);
        // defaultSeriesPaint
        p1.setDefaultSeriesPaint(new GradientPaint(1.0f, 2.0f, Color.RED, 3.0f, 4.0f, Color.BLACK));
        assertNotEquals(p1, p2);
        p2.setDefaultSeriesPaint(new GradientPaint(1.0f, 2.0f, Color.RED, 3.0f, 4.0f, Color.BLACK));
        assertEquals(p1, p2);
        ...
        p1.setDefaultSeriesOutlinePaint(new GradientPaint(1.0f, 2.0f, Color.CYAN, 3.0f, 4.0f, Color.GREEN));
        assertNotEquals(p1, p2);
        p2.setDefaultSeriesOutlinePaint(new GradientPaint(1.0f, 2.0f, Color.CYAN, 3.0f, 4.0f, Color.GREEN));
        assertEquals(p1, p2);
