...
public class AbstractRendererTest {
    ...
    public void testCloning() throws CloneNotSupportedException {
        ...
        r1.setSeriesPositiveItemLabelPosition(0, new ItemLabelPosition(ItemLabelAnchor.CENTER, TextAnchor.TOP_LEFT));
        r1.setSeriesNegativeItemLabelPosition(0, new ItemLabelPosition(ItemLabelAnchor.CENTER, TextAnchor.CENTER));
    ...
    public void testCloning2() throws CloneNotSupportedException {
        ...
        r1.setDefaultLegendTextPaint(new GradientPaint(1.0f, 2.0f, Color.RED, 3.0f, 4.0f, Color.BLUE));
        LineAndShapeRenderer r2 = CloneUtils.clone(r1);
        assertNotSame(r1, r2);
        assertSame(r1.getClass(), r2.getClass());
        assertEquals(r1, r2);
    ...
    public void testSerialization() {
        ...
        r1.setDefaultLegendTextPaint(new GradientPaint(1.0f, 2.0f, Color.RED, 3.0f, 4.0f, Color.GREEN));
    ...
    public void testPaintLookup() {
        ...
        CategoryPlot<String, String> plot = new CategoryPlot<>(null, new CategoryAxis("Category"), new NumberAxis("Value"), r);
