class EncoderUtilTest {
    ...
    void encodeThrowExceptionWhenRequiredInputsAreNull() {
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.encode(null, null));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.encode(bufferedImage, null));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.encode(bufferedImage, "pippo"));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.encode(null, null, 0f));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.encode(null, null, true));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.encode(bufferedImage, null, true));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.encode(null, null, defaultQualityLevel, true));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.encode(null, null, defaultQualityLevel, false));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.encode(bufferedImage, null, defaultQualityLevel, true));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.encode(bufferedImage, null, defaultQualityLevel, false));
    }

    @Test
    void throwsExceptionIfFormatIsInvalid() {
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.encode(bufferedImage, defaultInvalidFormat, defaultQualityLevel, false));
    }
    ...
    void writeBufferedImage_throwsExceptionWithAllNulls() {
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.writeBufferedImage(null, null, null));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.writeBufferedImage(null, null, null, defaultQualityLevel));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.writeBufferedImage(null, null, null, true));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.writeBufferedImage(null, null, null, true));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.writeBufferedImage(null, null, null, defaultQualityLevel, true));
    }

    @Test
    void writeBufferedImage_throwsExceptionWhenFormatIsNull() {
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.writeBufferedImage(bufferedImage, null, null));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.writeBufferedImage(bufferedImage, null, null, defaultQualityLevel));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.writeBufferedImage(bufferedImage, null, null, defaultQualityLevel, true));
    }

    @Test
    void writeBufferedImage_throwsExceptionWhenOutputStreamIsNull() {
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.writeBufferedImage(bufferedImage, defaultFormat, null, defaultQualityLevel));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.writeBufferedImage(bufferedImage, defaultFormat, null));
        assertThrows(IllegalArgumentException.class, () -> EncoderUtil.writeBufferedImage(bufferedImage, defaultFormat, null, defaultQualityLevel, true));
    }
